...
class FlashServer(object):
    ...
    def __init__(self):
        ...
        self.apps = dict({'rpnow': App, 'wirecast': Wirecast}) # supported applications: * means any as in {'*': App}
        self.clients = dict()  # list of clients indexed by scope. First item in list is app instance.
        self.root = '';
        
    def start(self, host='127.0.0.1', port=1935):
...
if __name__ == '__main__':
    ...
    parser = OptionParser(version='SVN $Revision: 164 $, $Date: 2012-10-08 15:08:44 -0700 (Mon, 08 Oct 2012) $'.replace('$', ''))
    parser.add_option('-i', '--host',    dest='host',    default='127.0.0.1', help="listening IP address. Default '127.0.0.1'")
